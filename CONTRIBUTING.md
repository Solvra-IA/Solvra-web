...
- No introducir librerías de UI nuevas (ya hay shadcn primitives, Radix, lucide, motion). Si crees que falta una, abre issue antes.
...
- Componentes nuevos en `components/ui/` siguiendo el patrón shadcn ya presente: tokens semánticos, primitives en `components/ui/shadcn/`, `motion/react` para animaciones.
